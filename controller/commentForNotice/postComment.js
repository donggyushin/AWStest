...
function () {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee(token, id, text) {
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            _context.next = 8;
            return _commentForNotice.default.create({
              text: text,
              userId: writer.id,
              noticeId: id
            });
          ...
          case 8:
            ...
            _context.next = 11;
            return _commentForNotice.default.findByPk(newComment.id, {
