...
var postCommentForQna =
/*#__PURE__*/
function () {
  var _ref = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
  _regenerator.default.mark(function _callee(token, qnaId, text) {
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            _context.next = 8;
            return _commentForQna.default.create({
              text: text,
              userId: writer.id,
              qnaId: qnaId
            });
          ...
          case 8:
            ...
            _context.next = 11;
            return _commentForQna.default.findByPk(newComment.id, {
  ...
  return function postCommentForQna(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

var _default = postCommentForQna;
